...
async function removeFromCart() {
  ...
  <div class="container px-5 py-24 mx-auto h-screen">
    <div class="lg:w-1/2 mx-auto flex flex-wrap">
      <img alt="ecommerce" class="lg:w-1/2 w-1/2 lg:h-full h-full" src={product.images[0].originalSrc}/>
      <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
          ...
          <div class="flex ml-6 items-center">
            ...
            <div class="relative">
              <select class="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-red-200 focus:border-red-500 text-base pl-3 pr-10">
                <option>Monthly(39.99)</option>
                <option>Yearly(99.99)</option>
                <option>2 Years(399.99)</option>
        ...
        <div class="flex">
          ...
          <button onClick={addToCart}  class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Add To Cart</button>
